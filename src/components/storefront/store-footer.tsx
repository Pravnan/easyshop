        ...
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-5">
          <div className="lg:col-span-2">
            <Link href={`/store/${store.slug}`}>
              <h3 className="mb-4 text-xl font-bold text-[#0D47A1]">{store.name}</h3>
            </Link>
            ...
            <div className="mt-6 flex gap-3">
              {store.facebookUrl && (
                <motion.a
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-200 text-gray-600 hover:bg-[#1565C0] hover:text-white transition-colors"
                  aria-label="Facebook"
                >
              ...
              <ul className="space-y-3">
                {group.links.map((link) => (
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="group inline-flex items-center gap-1 text-sm text-gray-500 hover:text-[#1565C0] transition-colors"
                    >
